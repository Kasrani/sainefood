	...
	<body class="dd">
        ...
        <div class="container main-content shadow confirmation contact">
            <div class="content">
                ...
                <h4 class="title-sf-4 text-center">Votre demande d'ouverture de compte est terminée</h4>
                <h4 class="title-sf-4 text-center">A bientôt sur votre Espace Client</h4><br>
        ...
        <footer>
            ...
            <div class="container">
                ...
                <div class="d-flex p-2 sous-title-footer end-footer">© 2018 par Mintea<br>Tous droits réservés.&nbsp;<a href="mentions-legales.php" style="line-height: 4.5;color:#CFCBC2;">Mentions légales.</a>&nbsp;<a href="CGV-CGU.php" style="line-height: 4.5;color:#CFCBC2;">CGV - CGU.</a></div>
            </div>
        </footer>
